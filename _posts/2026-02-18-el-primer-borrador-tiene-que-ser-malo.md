...
![Páginas escritas y tachadas sobre un escritorio](/assets/images/posts/borrador-escritura-proceso.jpg)
...
A eso se le llama <span class="tooltip-word" data-tooltip="El hábito de corregir y editar mientras se escribe el primer borrador. Es uno de los bloqueos más comunes: el cerebro no puede crear y criticar al mismo tiempo con la misma eficiencia. Uno de los dos pierde.">edición en caliente</span>. Y es el mayor enemigo de cualquier primer borrador.
...
Hay una técnica que en inglés se llama *vomit draft* —o <span class="tooltip-word" data-tooltip="Técnica de escritura donde se escribe sin parar durante un tiempo determinado, sin releer, sin corregir, sin borrar. El objetivo es sacar todo el material posible en crudo. La calidad no importa en esta etapa: importa la cantidad de material para trabajar después.">borrador vómito</span>— y el nombre es intencional. No es poético. Es descriptivo. Sacás todo afuera, sin filtro, sin orden, sin cuidado. Porque lo que necesitás primero es materia prima. La forma viene después.
...
Si ya llegaste al punto de tener algo escrito —aunque sea horrible— el siguiente paso es saber qué hacer con ese texto. Sobre eso escribí en [este post sobre la diferencia entre leer sobre escritura y realmente escribir](/3-blogs-que-debes-tener-en-cuenta/).
